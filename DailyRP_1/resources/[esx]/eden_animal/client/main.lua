...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
		if IsControlPressed(0, Keys['F10']) and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'eden_animal') and (GetGameTimer() - GUI.Time) > 150 then
            OpenAnimal()
...
function buy_animal()
    ...
    table.insert(elements, {label = _U('cat') .. '- <span style="color:green;">$15000</span>',             					value = "chat", price = 1000})
    table.insert(elements, {label = _U('wolf') .. '- <span style="color:green;">$30000</span>',             					value = "loup", price = 5000})
    table.insert(elements, {label = _U('bunny') .. '- <span style="color:green;">$25000</span>',             					value = "lapin",	price = 1000})
    table.insert(elements, {label = _U('husky') .. '- <span style="color:green;">$35000</span>',             					value = "husky", price = 5000})
    table.insert(elements, {label = _U('pig') .. '- <span style="color:green;">$10000</span>',             					value = "cochon", price = 1000})
    table.insert(elements, {label = _U('poodle') .. '- <span style="color:green;">$50000</span>',             					value = "caniche", price = 5000})
    table.insert(elements, {label = _U('pug') .. '- <span style="color:green;">$5000</span>',             					value = "carlin", price = 5000})
    table.insert(elements, {label = _U('retriever') .. '- <span style="color:green;">$10000</span>',             					value = "retriever", price = 5000})
    table.insert(elements, {label = _U('asatian') .. '- <span style="color:green;">$55000</span>',             					value = "berger", price = 10000})
    table.insert(elements, {label = _U('westie') .. '- <span style="color:green;">$50000</span>',             					value = "westie", price = 5000})
