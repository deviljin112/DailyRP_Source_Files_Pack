...
--== Show ID                                   ==
--===============================================
RegisterNUICallback('toggleid', function()
	exports['jsfour-idcard']:openID()
end)

--===============================================
--== Show License                              ==
--===============================================
RegisterNUICallback('togglelicense', function(data)
  TriggerServerEvent('menu:license', myIdentifiers, data)
end)
...
RegisterNUICallback('togglephone', function(data)
	exports['eden_demarches']:openMarches()
end)
...
RegisterNUICallback('NUIopenInventory', function()
	exports['es_extended']:ShowInventory()
end)
...
RegisterNetEvent('sendProximityMessageLicense')
AddEventHandler('sendProximityMessageLicense', function(id, message)
  local myId = PlayerId()
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "Typ licencji" .. "", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "Typ licencji" .. "", {0, 153, 204}, "^7 " .. message)
  end
end)
...
AddEventHandler('sendProximityMessagePhone', function(id, name, message)
  ...
  local pid = GetPlayerFromServerId(id)
  if pid == myId then
    TriggerEvent('chatMessage', "Nr. telefonu^3(" .. name .. ")", {0, 153, 204}, "^7 " .. message)
  elseif GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(myId)), GetEntityCoords(GetPlayerPed(pid)), true) < 19.999 then
    TriggerEvent('chatMessage', "Nr. telefonu^3(" .. name .. ")", {0, 153, 204}, "^7 " .. message)
  end
end)