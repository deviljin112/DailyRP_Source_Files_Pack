...
AddEventHandler('menu:id', function()
	  TriggerClientEvent("menu:openid")
end)
...
RegisterServerEvent('menu:license')
AddEventHandler('menu:license', function(myIdentifiers)
  getLicense(myIdentifiers.steamidentifier, function(data)
    if data ~= nil then
    TriggerClientEvent("sendProximityMessageLicense", -1, myIdentifiers.playerid, data.license)
  end
  end)
end)
