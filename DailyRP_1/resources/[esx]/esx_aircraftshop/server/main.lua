...
TriggerEvent('esx_society:registerSociety', 'aircraftdealer', _U('car_dealer'), 'society_aircraftdealer', 'society_aircraftdealer', 'society_aircraftdealer', {type = 'private'})
