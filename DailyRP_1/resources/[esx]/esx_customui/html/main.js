...
$(function(){
	window.addEventListener('message', function(event) {
		...
		/*}else if (event.data.action == "toggleCar"){
			...
			updateCarStatus(event.data.value)
...
/*
function updateCarStatus(value){
	...
	$('#belt .bg').css('background-color', color);
}
*/
...
function updateStatus(status){
	...
	$('#pee .bg').css('height', pee.percent+'%')
	$('#shit .bg').css('height', shit.percent+'%')
