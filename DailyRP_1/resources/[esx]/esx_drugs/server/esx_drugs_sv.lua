	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingMeth[source] == true then
			...
			if poochQuantity <= 9 then
				...
				if CopsConnected == 0 then
					xPlayer.addAccountMoney('black_money', math.random(2500,3500))
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingWeed[source] == true then
			...
			if poochQuantity <= 9 then
				...
				if CopsConnected == 0 then
					xPlayer.addAccountMoney('black_money', math.random(1500,2500))
