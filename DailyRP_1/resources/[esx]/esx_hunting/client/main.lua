...
---- BLIPS ----
local hunting = {
	{ ['x'] = -769.23773193359, ['y'] = 5595.6215820313, ['z'] = 33.48571395874 },
	{ ['x'] = 969.16375732422, ['y'] = -2107.9033203125, ['z'] = 31.475671768188 },
}

Citizen.CreateThread(function()
	for k,v in ipairs(hunting)do
	  ...
	  AddTextComponentString("Lowiectwo")
