...
Config.Zones = {
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -357.62, y = -87.97, z = 44.66 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -360.2, y = -75.84, z = 44.66 },
