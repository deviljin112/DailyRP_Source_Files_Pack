          ...
          if IsPedInAnyVehicle(ped) == false then
            ...
            if pedType ~= 28 and IsPedAPlayer(ped) == false then
              ...
              if distance <= 2 and ped  ~= GetPlayerPed(-1) and ped ~= oldped then
                ...
                if has == true then
                  drawTxt(0.90, 1.40, 1.0,1.0,0.4, "Wcisnij ~g~E~w~ aby sprzedac narkotyki", 255, 255, 255, 255)
...
AddEventHandler('notifyc', function()
    ...
    if crossing ~= nil then
      ...
      TriggerServerEvent('esx_phone:send', "police", "Ktos sprzedaje narkotyki na " .. streetName .. " i " .. crossing, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
      ...
      TriggerServerEvent('esx_phone:send', "police", "Ktos sprzedaje narkotyki na " .. streetName, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
