  ...
  AddEventHandler('drugs:trigger', function()
	selling = true
	    if selling == true then
            ...
            text = "Namawiasz do zakupu towaru",
            type = "error",
            queue = "lmao",
            timeout = 2500,
            layout = "Centerleft"
  ...
  AddEventHandler('drugs:sell', function()
	...
	local paymento = math.random (150,300)
		...
		if coke >= 1 and success == true then
				...
				TriggerClientEvent("pNotify:SendNotification", source, {
					text = "Sprzedales torebke koki za $" .. paymentc ,
					type = "success",
					progressBar = false,
					queue = "lmao",
					timeout = 2000,
  		...
  		elseif weed >= 1 and success == true then
  				TriggerClientEvent("pNotify:SetQueueMax", source, "lmao", 5)
				TriggerClientEvent("pNotify:SendNotification", source, {
					text = "Sprzedales jointy za $" .. paymentw ,
					type = "success",
					progressBar = false,
					queue = "lmao",
					timeout = 2000,
  		  ...
  		  elseif meth >= 1 and success == true then
  				TriggerClientEvent("pNotify:SetQueueMax", source, "lmao", 5)
				TriggerClientEvent("pNotify:SendNotification", source, {
					text = "Sprzedales torebke mety za $" .. paymentm ,
					type = "success",
					progressBar = false,
					queue = "lmao",
					timeout = 2000,
			...
			TriggerClientEvent("animation", source)
  			...
  			elseif opium >= 1 and success == true then
  				TriggerClientEvent("pNotify:SetQueueMax", source, "lmao", 5)
				TriggerClientEvent("pNotify:SendNotification", source, {
					text = "Sprzedales Heroine za $" .. paymento ,
					type = "success",
					progressBar = false,
					queue = "lmao",
					timeout = 2000,
