Locales['pl'] = {
  ...
  ['return_provider']         = 'oddaj pojazd do wlasciciela',
  ...
  ['return_provider_menu']    = 'salon samochodowy - Oddanie do wlasciciela',
  ...
  ['vehicle_sold_for']        = 'pojazd ~b~%s~s~ zostal ~y~sprzedany~s~ za ~g~$%s~s~',
