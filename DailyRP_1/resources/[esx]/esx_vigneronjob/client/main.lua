...
function OpenVigneActionsMenu()
	...
	if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'captain' then -- Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss'
...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Van Winnicy',  value = 'bison3'},
		}
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Winnica")
