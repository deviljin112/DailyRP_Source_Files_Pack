...
AddEventHandler('esx_vigneronjob:startHarvest', function(zone)
	...
	if PlayersHarvesting[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~Nie ladnie glitchowac, sprobuj jeszcze raz! ~w~')
...
AddEventHandler('esx_vigneronjob:stopHarvest', function()
	...
	if PlayersHarvesting[_source] == true then
		PlayersHarvesting[_source]=false
		TriggerClientEvent('esx:showNotification', _source, 'Wyszedles ze ~r~strefy')
	else
		TriggerClientEvent('esx:showNotification', _source, 'Mozesz ~g~zbierac')
		PlayersHarvesting[_source]=true
	end
end)
...
AddEventHandler('esx_vigneronjob:stopTransform', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Mozesz dalej ~g~przerabiac')
		PlayersTransforming[_source]=true
				...
				if (jus == 1) then
					SetTimeout(1100, function()
						...
						if societyAccount ~= nil then
							...
							xPlayer.addAccountMoney('bank', money2)
...
AddEventHandler('esx_vigneronjob:stopSell', function()
	...
	if PlayersSelling[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Mozesz ~g~sprzedawac')
		PlayersSelling[_source]=true
	end
