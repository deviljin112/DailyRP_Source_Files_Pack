...
local time = 400 -- Duration of the display of the text : 500 ~= 13sec
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            if IsControlJustPressed(1,  37) then
                search = "* Grzebie w Kieszeniach *"
                TriggerServerEvent('3dme:shareDisplay', search)
            end
    end
end)
