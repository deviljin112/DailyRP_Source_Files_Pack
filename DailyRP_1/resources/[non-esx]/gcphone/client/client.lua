  ...
  while true do
    ...
    if IsControlJustPressed(1, Keys['F1']) then
      ESX.TriggerServerCallback('gcphone:getItemAmount', function(qtty)
          ...
          UpMiniMapNotification("Nie posiadasz ~r~telefonu~s~")
        end
      end, 'phone')
...
AddEventHandler("gcphone:receiveMessage", function(message)
  ...
  Citizen.Trace('sendMessage: ' .. json.encode(messages))
    if message.owner == 0 then
        ...
        SetNotificationMessage("CHAR_CHAT_CALL", "CHAR_CHAT_CALL", false, 1, "~y~Nowa wiadomosc :~s~", "");
  ...
  if data.eventName ~= 'cancel' then
    if data.data ~= nil then 
      ...
      if data.eventName == "police" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Policje")
      elseif data.eventName == "taxi" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Taxi")
      elseif data.eventName == "mecano" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~Mechanika")
      elseif data.eventName == "journaliste" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~Reportera")
      elseif data.eventName == "ambulance" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Ambulans")
      elseif data.eventName == "unicorn" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~Unicorna")
      elseif data.eventName == "state" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~Rzadu")
      elseif data.eventName == "pilot" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Pilota")
      elseif data.eventName == "fib" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~FBI")
      elseif data.eventName == "army" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Armie")
      elseif data.eventName == "realestateagent" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Agenta Nieruchomosci")
      elseif data.eventName == "epicerie" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc do ~b~Sklepu")
      elseif data.eventName == "brinks" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~agenta Brinks")
      elseif data.eventName == "bahama" then
        ShowNotificationMenuCivil2("~h~Wyslales wiadomosc na ~b~Bahama mamas")
      end
