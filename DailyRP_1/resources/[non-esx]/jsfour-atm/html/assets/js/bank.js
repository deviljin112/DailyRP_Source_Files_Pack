...
function fleeca() {
  ...
  $('#welcome').text('Witamy w banku Flecca!');
}
...
function blaine() {
  ...
  $('#welcome').text('Witamy w banku Blaine County!');
}
...
function pacific() {
  ...
  $('#welcome').text('Witamy w banku Pacific Standards!');
}
...
$('#deposit').click(function() {
  if ( win > 1 ) {
    ...
    if ( amount.toLowerCase() == 'allt' && cash > 0) {
      ...
      $('.saldo').text('Stan konta: ' + bank.toString());
