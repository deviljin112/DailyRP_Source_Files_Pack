...
AddEventHandler('tp:hasEnteredMarker', function(zone)
    ...
    if zone == 'methwyjscie2' then
    	CurrentAction = zone
    end

    if zone == 'randomwejscie' then
    	CurrentAction = zone
    end

    if zone == 'randomwyjscie' then
    	CurrentAction = zone
    end
	
    if zone == 'pralnia' then
    	CurrentAction = zone
    end
	
    if zone == 'pralnia1' then
    	CurrentAction = zone
    end
